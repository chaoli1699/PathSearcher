...
//		mapId.setText(MapBuilder.mapBean.getMapId());
//		mapName.setText(MapBuilder.mapBean.getMapName());
//		unknowScale.setText(MapBuilder.mapBean.getUnknowScale()+"");
//		errAllowedRadiu.setText(MapBuilder.mapBean.getLocationErrorAllowed()+"");
//	}
}
